...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-sql/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-sql/actions/workflows/validate.yml)

Neovim tree-sitter queries for **sql**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-sql",
...
- [ ] Changes are scoped to `sql` — do not include files for other languages
